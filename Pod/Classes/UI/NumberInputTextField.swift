...
public class NumberInputTextField: StylizedTextField {
    ...
    open override var accessibilityValue: String? {
        get {
            // In order to read digits of the card number one by one, return them as "4 1 1 ..." separated by single spaces and commas in between groups for pauses
     ...
     */
    public var cardNumberFormatter: CardNumberFormatter {
    ...
    public func textFieldDidEndEditing(_ textField: UITextField) {
        ...
        numberInputTextFieldDelegate?.textFieldEndedEditing((textField as? NumberInputTextField) ?? NumberInputTextField())
    }
    ...
    private func addNumberInvalidityObserver() {
        NotificationCenter.default.addObserver(self, selector: #selector(notifyNumberInvalidity),
